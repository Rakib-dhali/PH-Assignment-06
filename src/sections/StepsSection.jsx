    ...
    <div className="max-w-400 bg-[#F9FAFC] py-10 md:py-30 sm:px-7 md:px-10 lg:px-20 xl:px-30 2xl:px-40 flex flex-col gap-10 items-center">
        ...
        <div className="flex items-center justify-center flex-col md:flex-row  gap-5">
            <div className="flex-center flex-col relative gap-5 rounded-2xl border-2 border-[#F1F1F1] bg-white  px-6 py-20" >
                ...
                <p className="leading-5 text-center text-nowrap text-[#627382]">Sign up for free in seconds. No credit card required to get started.</p>
            </div>
            ...
            <div className="flex-center flex-col relative gap-5 rounded-2xl border-2 border-[#F1F1F1] bg-white px-6 py-20" >
                ...
                <p className="leading-5 text-center text-nowrap text-[#627382]">Browse our catalog and select the tools that fit your needs.</p>
            </div>
            <div className=" flex-center flex-col relative gap-5 rounded-2xl border-2 border-[#F1F1F1] bg-white px-6 py-20" >
                ...
                <p className="leading-5 text-center text-nowrap text-[#627382]">Download and start using your premium tools immediately.</p>
            </div>
